...
echo "请选择下载地址："
echo -e "\033[33m1. 使用\033[0m(\033[32mgithub难以连接时推荐选这个\033[0m)\033[33m默认地址 https://github.moeyy.xyz/https://github.com/avilliai/Manyana/releases/download/Manyana/ManyanaLauncher_V2_3.rar\033[0m"
...
# 根据用户选择设置下载地址
if [ "$choice" == "1" ]; then
    file_url="https://github.moeyy.xyz/https://github.com/avilliai/Manyana/releases/download/Manyana/ManyanaLauncher_V2_3.rar"
elif [ "$choice" == "2" ]; then
...
if [ "$package_manager" = "apt" ];then
     apt install -qq -y libgbm1 libasound2 libgtk-3-0 libnotify4 libxss1 libxtst6 xdg-utils libatspi2.0-0 libsecret-1-0 wget unrar screen git openjdk-17-jdk unzip
else
     yum install -q -y epel-release wget unrar screen git java-17-openjdk java-17-openjdk-devel unzip xdg-utils mesa-libgbm alsa-lib gtk3 libnotify libXScrnSaver libXtst at-spi2-core libsecret
fi
